...
void	main()
{
	...
	var_Tex0 = attr_TexCoord0 + stScale * vec2( -2.14, 0.0 );
	var_Tex1 = attr_TexCoord0 + stScale * vec2( -0.4 , 0.0 );
	var_Tex2 = attr_TexCoord0 + stScale * vec2(  0.4 , 0.0 );
	var_Tex3 = attr_TexCoord0 + stScale * vec2(  2.14, 0.0 );
}
